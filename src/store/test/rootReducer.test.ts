...
const repo = {
	...
	releases_url: 'https://api.github.com/repos/facebook/react/releases{/id}', deployments_url: 'https://api.github.com/repos/facebook/react/deployments', created_at: '2013-05-24T16:15:54Z', updated_at: '2020-11-09T13:52:34Z', pushed_at: '2020-11-09T02:31:31Z', git_url: 'git://github.com/facebook/react.git', ssh_url: 'git@github.com:facebook/react.git', clone_url: 'https://github.com/facebook/react.git', svn_url: 'https://github.com/facebook/react', homepage: 'https://reactjs.org', size: 160476, stargazers_count: 158749, watchers_count: 158749, language: 'JavaScript', has_issues: true, has_projects: true, has_downloads: true, has_wiki: true, has_pages: true, forks_count: 31497, mirror_url: null, archived: false, disabled: false, open_issues_count: 622, license: { key: 'mit', name: 'MIT License', spdx_id: 'MIT', url: 'https://api.github.com/licenses/mit', node_id: 'MDc6TGljZW5zZTEz' }, forks: 31497, open_issues: 622, watchers: 158749, default_branch: 'master', score: 1, displayName: 'facebook/react/17-latest'
};
